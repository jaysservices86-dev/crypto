...
interface IAttestationConsumer {
    ...
    event AttestationExpired(bytes32 indexed contentHash, uint256 expiryTimestamp);
    ...
    function getAttestationSummaries(bytes32[] calldata contentHashes) external view returns (AttestationSummary[] memory);
